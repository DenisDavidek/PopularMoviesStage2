...
import sk.denis.davidek.popularmoviesstage2.adapters.MoviesAdapter;
...
import sk.denis.davidek.popularmoviesstage2.utilities.GlobalUtils;
import sk.denis.davidek.popularmoviesstage2.utilities.LayoutUtils;
...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<ArrayList<Movie>>,
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (selectedItemId) {
            ...
            case R.id.action_show_top_rated_movies:
                ...
                if (NetworkUtils.checkInternetConnection(this)) {
                    moviesRecyclerView.setAdapter(null);
                    getMoviesData(MOVIES_TOP_RATED);
    ...
    public void onLoadFinished(Loader<ArrayList<Movie>> loader, ArrayList<Movie> data) {
        ...
        if (!data.isEmpty()) {
            showMovieDataView();
            moviesAdapter = new MoviesAdapter(getApplicationContext(), data, this);
    ...
    public void onClick(int position) {
        ...
        String originalTitle = moviesList.get(position).getOriginalTitle();
        String moviePosterUrl = moviesList.get(position).getPosterUrl();
        String plotSynopsis = moviesList.get(position).getPlotSynopsis();
        double userRating = moviesList.get(position).getUserRating();
